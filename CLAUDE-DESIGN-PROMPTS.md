...
- **Colonne coordonnées** : **téléphone bien visible** « 514.895.4921 » en grand (Archivo, lien `tel:5148954921`), lien courriel placeholder « julie.gauthier@remax-quebec.com » (`mailto:`, bleu souligné), titre « Courtière immobilière agréée · RE/MAX Crystal », logo « REMAX CRYSTAL » blanc discret en rappel.
